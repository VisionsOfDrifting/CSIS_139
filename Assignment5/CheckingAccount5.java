...
public class CheckingAccount5 extends Account
{
    ...
    public CheckingAccount5(String accountName, double initialBalance) 
	{
    ...
    {
        if(EOptionsFrame.List == 1)
        {
            account1.listTransactions();
        }
        if(EOptionsFrame.List == 2)
        {
            account1.listChecks();
        }
        if(EOptionsFrame.List == 3)
        {
            account1.listDeposits();
        }
        if(EOptionsFrame.List == 4)
        {
